...
class QuizGenerator:
    ...
    def init_llm(self):
      ...
      #  )
        ...
        self.llm = GoogleGenerativeAI(model="gemini-1.5-pro", google_api_key="AIzaSyDQKKc1WbpCcjvrR95yXGg-rQTLhuP8054")
    ...
    def generate_question_with_vectorstore(self):
        ...
        chain = setup_and_retrieval | prompt | self.llm | JSparser
    ...
    def validate_question(self, question: dict) -> bool:
        ...
        for existing_question in self.question_bank:
            if existing_question.get('question') == question.get('question'):
                return False
        ##### YOUR CODE HERE #####
        return True
